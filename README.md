# Python-project
This is a Python coding repository for some basic Python questions.
...
Question 2:=>
While entering data, someone entered a few names as a common string “Ramesh Suresh Mohit”. Please write a program that separates all the names and converts them into a list. Once converted into a list, please write a program that adds their age. 
Ramesh:  25
Suresh: 22
Mohit: 26
